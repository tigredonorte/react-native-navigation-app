...
export const CategoryListMock: ICategoryModel[] = [
    ...
    { id: 'c7', title: 'Summer', subtitle: 'light and fresh food', color: '#babaca', img: require('../../../../assets/food/summer.jpg')},
    { id: 'c8', title: 'Winter', subtitle: 'Soups and hot food', color: '#abada1', img: require('../../../../assets/food/winter.jpeg')},
    { id: 'c9', title: 'German', subtitle: 'Embedded food', color: '#facada', img: require('../../../../assets/food/german.jpg')},
    { id: 'c10', title: 'Mexican', subtitle: 'Spice and tastfull', color: '#58123a', img: require('../../../../assets/food/mexican.jpg')},
    { id: 'c11', title: 'Peruvian', subtitle: 'Marine food', color: '#bbddff', img: require('../../../../assets/food/peruvian.jpg')},
